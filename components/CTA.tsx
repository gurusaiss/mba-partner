    ...
    <section style={{ padding: "96px 0", background: "var(--card)" }}>
      <div style={{ maxWidth: "1152px", margin: "0 auto", padding: "0 40px" }}>
        <div className="card" style={{
          ...
          <h2 className="serif" style={{ fontSize: "clamp(1.8rem, 3.5vw, 2.8rem)", fontWeight: 900, lineHeight: 1.15, letterSpacing: "-0.02em", color: "var(--text)", marginBottom: "20px" }}>
            Your Placement Season<br />Starts Today
          </h2>
          <p style={{ color: "var(--muted)", maxWidth: "480px", margin: "0 auto 40px", fontSize: "1rem", lineHeight: 1.75 }}>
