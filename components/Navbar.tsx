    ...
    <header style={{
      ...
      <div style={{ maxWidth: "1152px", margin: "0 auto", padding: "0 40px", height: "68px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        ...
        <nav className="hidden-mobile" style={{ display: "flex", alignItems: "center", gap: "32px" }}>
          {links.map(l => (
            <a key={l.href} href={l.href} style={{ fontSize: "0.9rem", fontWeight: 500, color: "var(--muted)", textDecoration: "none", transition: "color 0.2s" }}
        ...
        <div className="hidden-mobile" style={{ display: "flex", alignItems: "center", gap: "10px" }}>
          <a href="https://mbapartner.in" target="_blank" rel="noreferrer" className="btn-secondary" style={{ padding: "9px 18px", fontSize: "0.85rem" }}>Login</a>
          <a href="#enroll" className="btn-primary" style={{ padding: "9px 18px", fontSize: "0.85rem" }}>Enroll Now</a>
        </div>
          ...
          <div style={{ maxWidth: "1152px", margin: "0 auto", padding: "20px 40px", display: "flex", flexDirection: "column", gap: "16px" }}>
            {links.map(l => (
              <a key={l.href} href={l.href} onClick={() => setOpen(false)}
                style={{ fontSize: "1rem", fontWeight: 500, color: "var(--muted)", textDecoration: "none", padding: "4px 0" }}>
                {l.label}
              </a>
            ))}
